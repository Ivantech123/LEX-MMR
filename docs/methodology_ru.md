...
- **Система рейтинга Glicko-2.** В основе LexMMR™ лежит [система Glicko-2](https://de.wikipedia.org/wiki/Glicko-System) — современный метод оценки силы игроков в играх, разработанный профессором Марком Гликманом. В отличие от более простого рейтинга Эло, Glicko-2 учитывает не только результат (победа/поражение), но и «стабильность» этого результата. Ключевое преимущество — наличие **«отклонения» (Rating Deviation, RD)**, которое показывает степень уверенности в текущем рейтинге. Чем больше у юриста свежих дел, тем ниже RD и «стабильнее» его рейтинг. Если юрист долго не практикует, его RD растёт (система честно признаётся: «я пока не уверен»).
